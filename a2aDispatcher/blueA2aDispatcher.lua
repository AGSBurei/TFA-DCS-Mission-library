...
DetectionSetGroup:FilterPrefixes( { "EWB" } )
...
--Setup CAP RED
A2ADispatcher:SetSquadron( "CAP-LIWA", AIRBASE.PersianGulf.Tunb_Island_AFB, { "CAP-***-F18,"CAP-***-F15" }, 2000 )
A2ADispatcher:SetSquadronTakeoffInAir( "CAP-LIWA" )
A2ADispatcher:SetSquadronLandingAtEngineShutdown( "CAP-LIWA" )
...
A2ADispatcher:SetSquadronGrouping( "CAP-LIWA", 2 )
...
A2ADispatcher:SetSquadronCap( "CAP-LIWA", CAPliwa, 9000, 11000, 400, 500, 800, 1200 )
A2ADispatcher:SetSquadronCapInterval( "CAP-LIWA", 1, 420, 720, 1 )
 
 ---Fuel
A2ADispatcher:SetSquadronFuelThreshold( "CAP-LIWA", 0.5 )
